...
public class MedicalRecord extends Contract {
    ...
    public static final String FUNC_GETEXAMINATIONLISTBYADDRESS = "getExaminationListByAddress";

    public static final String FUNC_GETEXAMINATIONLISTBYTOKENID = "getExaminationListByTokenID";
    ...
    public RemoteFunctionCall<TransactionReceipt> addExamination(String soul, String code, String name, String note) {
        final Function function = new Function(
                FUNC_ADDEXAMINATION, 
                Arrays.<Type>asList(new Address(160, soul),
                new Utf8String(code),
                new Utf8String(name),
                new Utf8String(note)),
    ...
    public RemoteFunctionCall<TransactionReceipt> bindSoul(String soul, String fiscalCode) {
        final Function function = new Function(
                FUNC_bindSoul, 
                Arrays.<Type>asList(new Address(160, soul),
                new Utf8String(fiscalCode)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public RemoteFunctionCall<TransactionReceipt> bindSoul(String fiscalCode) {
        final Function function = new Function(
                FUNC_bindSoul, 
                Arrays.<Type>asList(new Utf8String(fiscalCode)),
                Collections.<TypeReference<?>>emptyList());
        return executeRemoteCallTransaction(function);
    }
    ...
    public static List<SoulboundEventResponse> getSoulboundEvents(TransactionReceipt transactionReceipt) {
        List<EventValuesWithLog> valueList = staticExtractEventParametersWithLog(SOULBOUND_EVENT, transactionReceipt);
    ...
    public static SoulboundEventResponse getSoulboundEventFromLog(Log log) {
        EventValuesWithLog eventValues = staticExtractEventParametersWithLog(SOULBOUND_EVENT, log);
        SoulboundEventResponse typedResponse = new SoulboundEventResponse();
        typedResponse.log = log;
        typedResponse.soul = (String) eventValues.getIndexedValues().get(0).getValue();
        typedResponse.tokenID = (BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
    ...
    public RemoteFunctionCall<List> getExaminationListByAddress(String soul) {
        final Function function = new Function(FUNC_GETEXAMINATIONLISTBYADDRESS, 
                Arrays.<Type>asList(new Address(160, soul)),
    ...
    public RemoteFunctionCall<List> getExaminationListByTokenID(BigInteger tokenID) {
        final Function function = new Function(FUNC_GETEXAMINATIONLISTBYTOKENID, 
                Arrays.<Type>asList(new Uint256(tokenID)),
                Arrays.<TypeReference<?>>asList(new TypeReference<DynamicArray<Examination>>() {}));
        return new RemoteFunctionCall<List>(function,
                new Callable<List>() {
