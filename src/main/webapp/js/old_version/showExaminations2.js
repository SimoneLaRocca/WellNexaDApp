...
document.getElementById("showExaminationsButton").addEventListener("click", async () => {
    try {
        // Chiamata alla funzione getExaminationList
        const examinations = await getExaminationList();

        // Aggiorna la tabella con i valori della lista
        updateTable(examinations);
    } catch (error) {
        console.error('Errore durante il recupero della lista di esami:', error);
    }
});

// Funzione per chiamare getExaminationList attraverso Metamask
async function getExaminationList() {
    try {
        ...
        if (window.ethereum) {
            ...
            // Chiama la funzione getExaminationList
            const examinations = await contract.methods.getExaminations().call();
        ...
        throw new Error('Errore durante il recupero della lista di esami:', error);
    }
}

// Funzione per aggiornare la tabella con i valori della lista
function updateTable(examinations) {
    ...
    // Itera attraverso la lista di esami e aggiungi righe alla tabella
    examinations.forEach((examination) => {
        // Crea una nuova riga
        const row = table.insertRow();

        // Aggiungi le celle con i valori dell'esame
